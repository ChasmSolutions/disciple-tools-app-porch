 ...
 */
class Disciple_Tools_App_Porch_Magic_Home_App extends DT_Magic_Url_Base
{
    public $magic = false;
    public $parts = false;
    public $page_title = 'Disciple Tools -  App';
    ...
    public function body(){
        ...
        <div class="off-canvas-wrapper">
            ...
            <div class="off-canvas position-right" id="offCanvasLeft" data-off-canvas data-transition="push">
                ...
                <div class="grid-x grid-padding-x" id="off-canvas-link-list"></div>
            </div>
        </div>
...
Disciple_Tools_App_Porch_Magic_Home_App::instance();
